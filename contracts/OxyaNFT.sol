...
contract OxyaNFT is ERC721("OxyaNFT", "OXYA"), ERC721Enumerable, Ownable {
    ...
    uint256 public NFTPrice = 30000000000000; // 0.00003 ETH
    bool public reveal;
     ...
     */
    function setGiveAwayActive(bool _isActive) external onlyOwner {
